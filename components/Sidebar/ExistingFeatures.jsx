...
import { BotMessageSquare, ChevronRight, MessagesSquare, Mic } from "lucide-react";
...
export default function ExistingFeatures() {
  ...
  async function fetchData() {
    try {
      ...
      const [fetchedChats, fetchedChatRooms, fetchedVoiceHalls] = await Promise.all([
        GetUserChats(dbUser._id),
        GetUserChatRooms(dbUser._id),
        GetUserVoiceHalls(dbUser._id),
      ]);
      console.log("Fetched data:", fetchedChats, fetchedChatRooms, fetchedVoiceHalls);
